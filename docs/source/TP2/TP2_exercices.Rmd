...
> **Question** : A partir de la matrice de comptage normalisés, affichez un graphique représentant le nombre de gènes ayant des comptages nuls en fonction des échantillons (utlisez le meme code couleur por les echantillons que precedemment) . Que remarquez-vous ?
